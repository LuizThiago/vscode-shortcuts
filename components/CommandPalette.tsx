...
export function CommandPalette({ value, onChange }: CommandPaletteProps) {
  return (
    <div className="relative max-w-2xl mx-auto mb-6 md:mb-12 group">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-card/50 backdrop-blur-xl border border-border rounded-xl py-3 md:py-4 pl-10 md:pl-12 pr-12 md:pr-4 text-sm md:text-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all placeholder:text-muted-foreground/50"
        />
        <div className="absolute right-3 md:right-4 top-1/2 -translate-y-1/2 flex gap-1">
